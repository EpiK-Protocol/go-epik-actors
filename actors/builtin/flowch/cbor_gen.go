...
func (t *UpdateChannelStateParams) MarshalCBOR(w io.Writer) error {
	...
	// t.Sv (flowch.SignedVoucher) (struct)
...
func (t *SignedVoucher) MarshalCBOR(w io.Writer) error {
	...
	// t.Extra (flowch.ModVerifyParams) (struct)
...
var lengthBufAddFundsParams = []byte{129}

func (t *AddFundsParams) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
	if _, err := w.Write(lengthBufAddFundsParams); err != nil {
		return err
	}
...
func (t *AddFundsParams) UnmarshalCBOR(r io.Reader) error {
	*t = AddFundsParams{}
