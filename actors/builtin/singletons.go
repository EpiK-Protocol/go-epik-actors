...
var (
	...
	ExpertFundActorAddr    = mustMakeAddress(50)
	RetrievalFundActorAddr = mustMakeAddress(51)
	VoteFundActorAddr      = mustMakeAddress(52)
	KnowledgeFundActorAddr = mustMakeAddress(53)
	VestingActorAddr       = mustMakeAddress(54)
