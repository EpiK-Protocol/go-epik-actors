...
import (
	...
	market "github.com/EpiK-Protocol/go-epik-actors/actors/builtin/market"
...
func (a Actor) SubmitWindowedPoSt(rt Runtime, params *SubmitWindowedPoStParams) *adt.EmptyValue {
	...
	rt.State().Transaction(&st, func() interface{} {
		...
		// https://github.com/EpiK-Protocol/go-epik-actors/issues/410
...
func (a Actor) ConfirmSectorProofsValid(rt Runtime, params *builtin.ConfirmSectorProofsParams) *adt.EmptyValue {
	...
	for _, sectorNo := range params.Sectors {
		...
		// https://github.com/EpiK-Protocol/go-epik-actors/issues/474
		...
		// TODO: we should batch these calls...
		// https://github.com/EpiK-Protocol/go-epik-actors/issues/475
		...
		// https://github.com/EpiK-Protocol/go-epik-actors/issues/476
		newlyVestedAmount := rt.State().Transaction(&st, func() interface{} {
			newlyVestedFund, err := st.UnlockVestedFunds(store, rt.CurrEpoch())
			if err != nil {
...
func (a Actor) ReportConsensusFault(rt Runtime, params *ReportConsensusFaultParams) *adt.EmptyValue {
	...
	// TODO: terminate deals with market actor, https://github.com/EpiK-Protocol/go-epik-actors/issues/279
...
func handleProvingPeriod(rt Runtime) {
...

	{
		...
		rt.State().Transaction(&st, func() interface{} {
			...
			// https://github.com/EpiK-Protocol/go-epik-actors/issues/411
...
func computeFaultsFromMissingPoSts(st *State, deadlines *Deadlines, sinceDeadline, beforeDeadline uint64) (detectedFaults, failedRecoveries *abi.BitField, err error) {
	...
	// https://github.com/EpiK-Protocol/go-epik-actors/issues/477
	partitionSize := st.Info.WindowPoStPartitionSectors
...
// https://github.com/EpiK-Protocol/go-epik-actors/issues/483
func terminateSectors(rt Runtime, sectorNos *abi.BitField, terminationType power.SectorTermination) {
	...
	// https://github.com/EpiK-Protocol/go-epik-actors/issues/478
...
func verifyPledgeMeetsInitialRequirements(rt Runtime, st *State) {
	...
	// https://github.com/EpiK-Protocol/go-epik-actors/issues/415
}
