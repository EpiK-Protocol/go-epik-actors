...
func (t *Deadlines) MarshalCBOR(w io.Writer) error {
	...
	// t.Due ([56]*bitfield.BitField) (array)
...
func (t *Deadlines) UnmarshalCBOR(r io.Reader) error {
	...
	if extra != 56 {
		return fmt.Errorf("expected array to have 56 elements")
	}

	t.Due = [56]*bitfield.BitField{}
...
func (t *RemoveSectorParams) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
...
func (t *RemoveSectorParams) UnmarshalCBOR(r io.Reader) error {
	br := cbg.GetPeeker(r)
